...
function consultants_setup_post_type()
{

	$labels = array(
		'name'                  => _x('Consultants', 'Post Type General Name', 'text_domain'),
		'singular_name'         => _x('Consultant', 'Post Type Singular Name', 'text_domain'),
		'menu_name'             => __('Consultants', 'text_domain'),
		'name_admin_bar'        => __('Consultants', 'text_domain'),
